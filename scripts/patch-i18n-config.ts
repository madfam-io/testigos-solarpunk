...
// Add missing English translations after line containing 'resources.hero.title': 'Resource Center',
const englishTranslations = `    'resources.actors.title': 'For Actors',
    'resources.creators.title': 'For Creators',
    'resources.sponsors.title': 'For Sponsors',`;

// Find the right place to insert English translations
const englishInsertPoint = configContent.indexOf(
  "'resources.hero.title': 'Resource Center',"
);
if (englishInsertPoint !== -1) {
  const lineEnd = configContent.indexOf('\n', englishInsertPoint);
  configContent =
    configContent.slice(0, lineEnd + 1) +
    englishTranslations +
    '\n' +
    configContent.slice(lineEnd + 1);
  console.log('✅ Added English translations');
}

// Add missing Spanish translations - find where to insert them
// Look for a good place in the Spanish section, after impact translations
const spanishTranslations = `
    // Missing impact and metrics translations
    ...
    'testimonials.maria': 'Los sketches me hicieron ver que puedo ser sostenible sin ser perfecta. Ahora la composta es parte de mi rutina diaria.',
    'testimonials.maria.name': 'María, 28 años',
    'testimonials.roberto': 'Mis estudiantes ahora ven la sostenibilidad como algo cool gracias a los videos. Empezamos un huerto escolar inspirados en ustedes.',
    'testimonials.roberto.name': 'Prof. Roberto',
    'testimonials.carlos': 'Instalé paneles solares después de ver el sketch del Hermano Voltio. Mi recibo de luz bajó 80% y ahora predico el evangelio solar.',
    ...
    'content.page.description': 'Explora todas las fases de contenido de Testigos de Solarpunk: Sketches, Podcast y MADLAB',
    'content.hero.title': 'Contenido Testigos de Solarpunk',
    'content.hero.subtitle': 'Una estrategia de contenido de tres fases para conectar, concientizar y crear comunidad',
    'phase.1.sketches': 'Fase 1: Sketches',
    'phase.2.podcast': 'Fase 2: Podcast',
    'phase.3.madlab': 'Fase 3: MADLAB',
    'content.phase1.description': 'Sketches cómicos virales de 60-90 segundos que rompen barreras culturales sobre la sostenibilidad. Con personajes memorables y humor inteligente, llevamos el mensaje ecológico a las masas.',
    'content.phase2.description': 'MADFAM Podcast profundiza en conversaciones de 20-30 minutos con expertos, activistas y visionarios. Exploramos soluciones prácticas y escalables para los desafíos ambientales actuales.',
    'content.phase3.description': 'Laboratorios de innovación sostenible: eventos presenciales y experiencias educativas en escuelas que transforman comunidades. Llevamos la teoría a la práctica con talleres y activaciones.',
    ...
    'resources.hero.subtitle': 'Herramientas, guías y materiales para creadores, patrocinadores y defensores del solarpunk',
    'resources.for.creators': 'Para Creadores',
    'resources.creators.description': 'Todo lo que necesitas para crear contenido en nuestro universo',
    'resources.script.templates': 'Plantillas de Guiones',
    'resources.script.templates.desc': 'Formatos optimizados para cada plataforma',
    'resources.character.sheets': 'Fichas de Personajes',
    'resources.character.sheets.desc': 'Perfiles detallados para desarrollo narrativo',
    'resources.worldbuilding.guide': 'Guía de Worldbuilding',
    'resources.worldbuilding.guide.desc': 'Reglas y coherencia del universo solarpunk',
    ...
    'resources.character.analysis.desc': 'Motivaciones, historias y arcos narrativos',
    ...
    'resources.integration.opportunities.desc': 'Formas orgánicas de participar en las historias',
    ...
    'philosophy.radical.optimism.desc': 'Creemos que un futuro mejor no solo es posible, sino inevitable si trabajamos juntos.',
    'philosophy.local.action': 'Acción Local',
    'philosophy.local.action.desc': 'Los cambios globales comienzan con transformaciones en nuestras comunidades.',
    'philosophy.appropriate.tech': 'Tecnología Apropiada',
    'philosophy.appropriate.tech.desc': 'La mejor tecnología es aquella que resuelve problemas reales respetando el ambiente.',
    'philosophy.regenerative.diversity': 'Diversidad Regenerativa',
    'philosophy.regenerative.diversity.desc': 'La fuerza viene de la diversidad de voces, culturas y soluciones.',
...
// Find the Spanish section - look for 'impact.cta.volunteer': 'Unirse como Voluntario',
const spanishInsertPoint = configContent.indexOf(
  "'impact.cta.volunteer': 'Unirse como Voluntario',"
);
if (spanishInsertPoint !== -1) {
  const lineEnd = configContent.indexOf('\n', spanishInsertPoint);
  configContent =
    configContent.slice(0, lineEnd + 1) +
    spanishTranslations +
...
console.log(
  '✅ Successfully updated i18n config with all missing translations!'
);
