...
describe('TelemetryManager', () => {
  ...
  describe('Initialization and Consent', () => {
    ...
    it('should respect user consent when enabling', () => {
      ...
      // Enable telemetry
      telemetry.enable();
      expect(localStorageMock.setItem).toHaveBeenCalledWith('testigos-telemetry-consent', 'granted');
  ...
  describe('Event Tracking', () => {
    ...
    it('should track custom events with properties', () => {
      ...
      expect(customEvent?.properties?.sessionId).toBe('1640995200000-4fzzzxjyl');
      expect(customEvent?.properties?.userAgent).toBe('Mozilla/5.0 Test Browser');
  ...
  describe('Error Tracking', () => {
    ...
    it('should track Error objects', () => {
      ...
      expect(errorEvent?.properties?.stack).toContain('Error: Test error message');
...
describe('initializeTelemetry', () => {
  ...
  it('should setup event listeners', () => {
    ...
    expect(mockAddEventListener).toHaveBeenCalledWith('themeChange', expect.any(Function));
    expect(mockAddEventListener).toHaveBeenCalledWith('languageChange', expect.any(Function));
